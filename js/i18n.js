...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      'meta.certifications.title': 'Certifications | Agon Mustafaj — Python, Power BI, SEO & Networking',
      'meta.certifications.desc': 'Course certificates and learning credentials from Coursera, Credly and KREN, covering Python, Power BI, Excel, SEO, networking, DevOps and cybersecurity fundamentals.',
    ...
    sq: {
      ...
      'meta.certifications.title': 'Certifikata | Agon Mustafaj — Python, Power BI, SEO dhe rrjeta',
      'meta.certifications.desc': 'Certifikata kursesh dhe kredenciale mësimi nga Coursera, Credly dhe KREN, për Python, Power BI, Excel, SEO, rrjeta, DevOps dhe baza të kibernetikës.',
      ...
      'home.learnLead': 'Certifikata kursesh për Python, Power BI, SEO, rrjeta dhe baza të kibernetikës, si pjesë e mësimit tim përkrah studimeve.',
      ...
      'certs.lead': 'Certifikata kursesh nga Coursera, Credly dhe KREN, për Python, Power BI, Excel, SEO, rrjeta, DevOps dhe baza të kibernetikës. Këto tregojnë çfarë kam studiuar, jo përvojë profesionale pune.',
      'certs.all': 'Të gjitha',
