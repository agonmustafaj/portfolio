...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      'projects.bank-marketing': 'Data analysis and machine learning project exploring bank marketing campaign data.',
    ...
    sq: {
      ...
      'projects.bank-marketing': 'Projekt analize të dhënash dhe machine learning mbi fushatat e marketingut bankar.',
      ...
      'case.nApproach': '03. Qasja',
      'case.nClass': '04. Klasifikimi',
      'case.nCluster': '05. Grupimi dhe dimensionaliteti',
      'case.nAssoc': '06. Rregullat e asociimit',
      'case.idea': 'Ideja',
      ...
      'case.approach': 'Qasja',
      'case.approachTitle': 'Qasja analitike',
      'case.class': 'Klasifikimi',
      'case.classTitle': 'Modelet e klasifikimit',
      'case.cluster': 'Grupimi dhe dimensionaliteti',
      'case.clusterTitle': 'Grupimi dhe ulja e dimensioneve',
      'case.assoc': 'Rregullat e asociimit',
      'case.assocTitle': 'Minimi i rregullave të asociimit',
      ...
      'bank.lead': 'Projekt analize të dhënash dhe machine learning mbi fushatat e marketingut bankar.',
      'bank.idea': 'Ky projekt shqyrton të dhënat e fushatave të marketingut bankar për të kuptuar sjelljen e klientëve, për të parashikuar rezultatet dhe për të gjetur modele me data science dhe machine learning.',
      'bank.built': 'Një pipeline i plotë analize: përpunim të dhënash, analizë eksploruese, modele klasifikimi, grupim, ulje dimensionesh dhe minimi i rregullave të asociimit.',
      'bank.approach': 'Nisa me pastrimin dhe eksplorimin e të dhënave, pastaj analizë veçorish dhe zgjedhje modelesh: të mbikëqyrura për klasifikim dhe të pa mbikëqyrura për zbulimin e modeleve.',
      'bank.class': 'Për parashikimin e rezultatit të fushatës përdora Random Forest, Logistic Regression dhe Decision Tree, dhe i krahasova sipas performancës në këtë set të dhënash.',
      'bank.cluster': 'K-Means për të gjetur grupe natyrore; PCA për të ulur dimensionalitetin dhe për të parë lidhjet mes veçorive.',
      'bank.assoc': 'Algoritmi Apriori për rregulla asociimi, për të zbuluar lidhje mes variablave në setin e marketingut.',
      'bank.learned': 'Ky projekt e forcoi kuptimin e ciklit të plotë të analizës, nga të dhënat e papërpunuara te përfundimet e dobishme, dhe vlerën e disa teknikave së bashku.',
      'bank.placeholder': 'Analiza e marketingut bankar',
      'bank.dataUrl': 'Projekt analize të dhënash',
      'bank.f1': 'Përpunim të dhënash',
      'bank.f2': 'Modele klasifikimi',
      'bank.f3': 'Random Forest',
      'bank.f4': 'Logistic Regression',
      'bank.f5': 'Decision Tree',
      'bank.f6': 'Grupim K-Means',
      'bank.f7': 'PCA',
      'bank.f8': 'Minimi i rregullave të asociimit',
      'bank.f9': 'Algoritmi Apriori',
