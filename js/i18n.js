...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      'skill.Python': 'Programming and data analysis fundamentals, learned at university and reinforced with courses.',
      'skill.Pandas': 'Working with datasets in Python, learned at university and reinforced with courses.',
      'skill.NumPy': 'Numerical computing in Python, learned at university and reinforced with courses.',
      'skill.Power BI': 'Power Query, data modeling, and visualization, learned at university and reinforced with courses.',
      'skill.Excel': 'Preparing and organizing data in spreadsheets, learned at university and reinforced with courses.',
      'skill.DAX': 'Expressions for Power BI models, learned at university and reinforced with courses.',
      'skill.Data Modeling': 'Structuring data for reporting, learned at university and reinforced with courses.',
    ...
    sq: {
      ...
      'skill.Python': 'Baza të programimit dhe analizës së të dhënave, të mësuara në universitet dhe të përforcuara me kurse.',
      'skill.Pandas': 'Punë me të dhëna në Python, e mësuar në universitet dhe e përforcuar me kurse.',
      'skill.NumPy': 'Llogaritje numerike në Python, e mësuar në universitet dhe e përforcuar me kurse.',
      'skill.Power BI': 'Power Query, modelim dhe vizualizim të dhënash, të mësuara në universitet dhe të përforcuara me kurse.',
      'skill.Excel': 'Përgatitje dhe organizim i të dhënave në spreadsheet, të mësuara në universitet dhe të përforcuara me kurse.',
      'skill.DAX': 'Shprehje për modelet në Power BI, të mësuara në universitet dhe të përforcuara me kurse.',
      'skill.Data Modeling': 'Strukturim i të dhënave për raportim, i mësuar në universitet dhe i përforcuar me kurse.',
